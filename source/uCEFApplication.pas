...
type
  TCefApplication = class
    ...
    public
      ...
      property ContextSafetyImplementation       : TCefContextSafetyImplementation     read FContextSafetyImplementation       write FContextSafetyImplementation;
...
begin
  ...
  case FContextSafetyImplementation of
    ...
    else              aSettings.context_safety_implementation   := 0;
  end;
...
procedure TCefApplication.Internal_OnRegisterCustomSchemes(const registrar: ICefSchemeRegistrar);
begin
